...
- **`loadData`s Mid-Tour-Guard aus 5a bleibt wirksam** — dieser Task darf ihn nicht umgehen, auch nicht für das Neuladen nach dem Anwenden. Wenn das Neuladen dadurch nicht durchkommt, ist das ein echter Konflikt: melden, nicht umbauen.
